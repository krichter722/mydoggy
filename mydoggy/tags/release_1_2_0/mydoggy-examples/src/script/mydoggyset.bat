...
SET CLASS_PATH=%MYDOGGY_HOME%\lib\mydoggy-api-1.2.0.jar
SET CLASS_PATH=%CLASS_PATH%;%MYDOGGY_HOME%\lib\mydoggy-plaf-1.2.0.jar
SET CLASS_PATH=%CLASS_PATH%;%MYDOGGY_HOME%\lib\mydoggy-examples-1.2.0.jar
SET CLASS_PATH=%CLASS_PATH%;%MYDOGGY_HOME%\lib\TableLayout-20020517.jar
